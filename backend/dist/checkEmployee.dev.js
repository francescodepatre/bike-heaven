...
function checkEmployee(id) {
  var connection, MYSQLQUERY, _ref, _ref2, rows, row, idEmployee;

  return regeneratorRuntime.async(function checkEmployee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          MYSQLQUERY = "SELECT id FROM employees WHERE id = '".concat(id, "'");
          _context.next = 5;
