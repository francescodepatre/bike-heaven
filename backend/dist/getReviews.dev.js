    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          MYSQLQUERY = "SELECT customers.name as \"FirstName\", customers.surname as \"LastName\", reviews.value as \"Value\", reviews.reviewContent as \"Content\", reviews.id as \"Id\" FROM reviews JOIN customers ON reviews.codCustomer = customers.idcustomer WHERE reviews.codProduct = ".concat(id);
          _context.next = 5;
