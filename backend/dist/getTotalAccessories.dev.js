...
function getTotalAccessories() {
  var connection, MYSQLQUERY, _ref, _ref2, rows, row, accNum, accValue;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          MYSQLQUERY = "SELECT SUM(accessories.price) as totalAcc, SUM(accessories.quantity) as accNum FROM accessories";
          _context.next = 5;
