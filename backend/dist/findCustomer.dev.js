...
function getCustomer(id) {
  var connection, MYSQLQUERY, _ref, _ref2, rows, row, name, surname, email, phone, address;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          MYSQLQUERY = "SELECT name, surname, email, address, phone FROM customers WHERE idcustomer = ".concat(id);
          _context.next = 5;
